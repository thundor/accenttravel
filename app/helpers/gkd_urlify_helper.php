...
class URLify {
    ...
    */
    'bg' => array( /* Bulgarian */
			"Щ" => 'Sht', "Ш" => 'Sh', "Ч" => 'Ch', "Ц" => 'Ts', "Ю" => 'Yu', "Я" => 'Ya',
			"Ж" => 'Zh',  "А" => 'A',  "Б" => 'B',  "В" => 'V', "Г" => 'G',  "Д" => 'D',
			"Е" => 'E',   "З" => 'Z',  "И" => 'I',  "Й" => 'Y', "К" => 'K',  "Л" => 'L',
			"М" => 'M',   "Н" => 'N',  "О" => 'O',  "П" => 'P', "Р" => 'R',  "С" => 'S',
			"Т" => 'T',   "У" => 'U',  "Ф" => 'F',  "Х" => 'H', "Ь" => 'Y',   "Ъ" => 'A',
			"щ" => 'sht', "ш" => 'sh', "ч" => 'ch', "ц" => 'ts', "ю" => 'yu', "я" => 'ya',
			"ж" => 'zh',  "а" => 'a',  "б" => 'b',  "в" => 'v', "г" => 'g',  "д" => 'd',
			"е" => 'e',   "з" => 'z',  "и" => 'i',  "й" => 'y', "к" => 'k',  "л" => 'l',
			"м" => 'm',   "н" => 'n',  "о" => 'o',  "п" => 'p', "р" => 'r',  "с" => 's',
    ...
    'sk' => array ( /* Slovak */
      ...
      'Ú' => 'U', 'Ý' => 'Y', 'Ž' => 'Z'
		...
		'vn' => array ( /* Vietnamese */
			...
			'Đ' => 'D', 'đ' => 'd',
      'ą' => 'a','ę' => 'e','ǝ' => 'e','ə' => 'e','ɛ' => 'e','I' => 'i','ǐ' => 'i','ĭ' => 'i','ī' => 'i','į' => 'i','İ' => 'i','ǒ' => 'o','ŏ' => 'o','ō' => 'o','ő' => 'o','ǫ' => 'o','ǿ' => 'o','ǔ' => 'u','ŭ' => 'u','ū' => 'u','ű' => 'u','ů' => 'u','ų' => 'u','Y' => 'y','ŷ' => 'y','ȳ' => 'y','ƴ' => 'y',
		),
		'ar' => array ( /* Arabic */
    ...
    if (function_exists('mb_substr')) {
      return trim (mb_substr ($text, 0, (int)$length), '-');     // trim to first $length chars
    } else {
