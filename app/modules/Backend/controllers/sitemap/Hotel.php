...
class Hotel extends MX_Controller {
  ...
  public function index() {
    ...
    $this->data = $this->Options_model->get('trip_hotel_settings');
    $this->theme->view('backend/trip/hotel_settings', $this->data);
  }
  public function save() {
    ...
    if($this->validate()){
      ...
      if(!isset($options['departure_locations'])){
        $options['departure_locations'] = null;
      }
      $this->Options_model->set('trip_hotel_settings',$options);
    }
