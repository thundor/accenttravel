...
class Hotelsasync extends MX_Controller {
  ...
  public function index() {
    $this->setData();
    $this->theme->view('trip/hotelsasync/index', $this->data, $this);
  }
  public function search() {
    $this->setData();
    $this->theme->set_sublayout('frontend/waiting/index');
    $this->theme->view('trip/hotelsasync/search', $this->data, $this);
  }
  ...
  public function loadResults() {
    if ($this->input->is_ajax_request()) {
      ...
      $this->response = $this->Hotels_model->loadHotels($code, true, $page, $sort_by, $sort_order, $request_filters);
      if (!$this->response) {
