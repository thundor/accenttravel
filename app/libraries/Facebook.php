...
class Facebook{
  ...
  public function __construct(){
    ...
    $settings = $this->Options_model->get('social_networks_settings',null,array(
      'facebook_app_id'=>'',
      'facebook_app_secret'=>'',
      'facebook_default_graph_version'=>'v2.10',
      'facebook_login_type'=>'web',
      'facebook_auth_on_load'=>false,
      'facebook_login_redirect_url'=>'account/facebook/login',
      'facebook_logout_redirect_url'=>'account/facebook/logout',
    ...
    $this->config->set_item('facebook_app_id', $settings['facebook_app_id']);
    $this->config->set_item('facebook_app_secret', $settings['facebook_app_secret']);
    $this->config->set_item('facebook_default_graph_version', $settings['facebook_default_graph_version']);
    $this->config->set_item('facebook_login_type', $settings['facebook_login_type']);
    $this->config->set_item('facebook_auth_on_load', $settings['facebook_auth_on_load']);
    $this->config->set_item('facebook_login_redirect_url', $settings['facebook_login_redirect_url']);
    $this->config->set_item('facebook_logout_redirect_url', $settings['facebook_logout_redirect_url']);
    $this->config->set_item('facebook_permissions', $settings['facebook_permissions']);
  ...
  public function login_url(){
    ...
    return $this->helper->getLoginUrl(
      site_url($this->config->item('facebook_login_redirect_url')),
  ...
  public function logout_url(){
    ...
    return $this->helper->getLogoutUrl(
      ...
      site_url($this->config->item('facebook_logout_redirect_url'))
    );
  }
  ...
  public function get_user(){
    return $this->request('get', '/me?fields=id,last_name,middle_name,first_name,gender,email,birthday,verified');
  }
}