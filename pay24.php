...
const executePay24 = function(){
	if(getCookie('pay24theme')){
		var r = 1;
		// r = confirm('Dezactivare Demo?');
		if(r){
			deleteCookie('pay24theme');
			window.location = '/';
		}
	} else {
		var r = 1;
...
<button onclick="executePay24()" style="height:30vh; width:30vw; margin:auto;">Executa</button>
</div>