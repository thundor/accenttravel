...
<?php 
$search_data = [];
$special_layout = $this->_controller=='Chartere';
...
<v-window class="" :touch="false">
	<v-window-item :value="0" class="w-100 fill-height">
		...
		>
			<component :is="loadViewAsync('partials/search-wrapper')" activate_menu="travelfuse-chartere" :defaults="<?php echo htmlspecialchars(json_encode(['travelfuse-chartere' => $search_data]), ENT_QUOTES); ?>">
