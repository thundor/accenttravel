export default {
  ...
  props: {
	...
	template : `
<v-dialog :persistent="persistent" v-model="dialog" fullscreen :scrim="false" transition="dialog-bottom-transition" v-on:click:outside.stop="(e) => {e.preventDefault();e.stopPropagation();e.stopImmediatePropagation();return false;}">
