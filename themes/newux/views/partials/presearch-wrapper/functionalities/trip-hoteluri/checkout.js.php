...
export default {
	...
	methods: {
		checkout: function(){
			...
			v && v.then(() => {
				console.warn('this.hotel', this.result);
				/* var billing_info = {};
				...
				var data = 
				{
					...
					hotel: {
						...
						expected_price: priceObj.Amount,
					},
