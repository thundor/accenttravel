export default {
	...
	Merch: {
		...
		"pool access": [/(pool\s+access|acces\s+(gratuit\s+)?(la\s+)?piscina)/mi,'Acces la piscina'],
		"jacuzzi access": [/(jacuzzi\s+access|acces\s+(gratuit\s+)?(la\s+)?jacuzzi)/mi,'Acces la jacuzzi'],
		"transfer-aeroport": [/transfer.*aeroport/mi,'Transfer aeroport'],
	},
	Meal: {
		"bb": [/(\bbb\b|mic dejun|breakf)/mi,'Mic dejun'],
		"dp": [/\b(dp|hb|half.?board|demi.?pensiune)\b/mi,'Demipensiune'],
		"fb": [/^(fb|pc|full board)$/mi,'Pensiune completa'],
		"ro": [/^ro$/mi,'In camera'],
