...
export { createVPhoneInput, VPhoneInput, VCountryIconSprite, VCountryIconSvg, countries, Ip2cCountryGuesser, MemoIp2cCountryGuesser, StorageMemoIp2cCountryGuesser, makePhone, makeExample, formatPhone, DEFAULT_OPTIONS, mergeOptions, getOption, };
