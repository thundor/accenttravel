...
function removeLocationParam(key) {
  window.history.replaceState("", document.title, removeParam(key,window.location.href));
}
...
function titleCase(str) {
  ...
  for(i=0;i<newstr.length;i++){
    ...
    if(lowerwords.indexOf(newstr[i])>=0){
      continue;
    }
    var copy = newstr[i].substring(1);
