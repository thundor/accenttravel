...
$L1['meta_title_add'] = 'Creare comanda TravelFuse';
$L1['meta_title_edit'] = 'Editare comanda TravelFuse';
$L1['action_edit'] = 'Editare comanda TravelFuse';
$L1['action_edit/html'] = '<i class="fa fa-pencil"></i> <span>' .$L1['action_edit'] . '</span>';
$L1['action_add'] = 'Creare comanda TravelFuse';
$L1['action_add/html'] = '<i class="fa fa-plus"></i> <span>' .$L1['action_add'] . '</span>';
if(isset($_GET['id']) && $_GET['id']){
  $L1['page_title/html'] = '<span>Editare</span> <strong class="text-success">Comanda TravelFuse</strong>';
