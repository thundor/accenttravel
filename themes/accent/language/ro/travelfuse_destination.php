...
themeFunctions::loadLang('travelfuse_destinations');
$L1['meta_title'] = 'Destinatie Travelfuse ' . lang('append_title');
$L1['page_title/html'] = '<span>Informatii</span> <strong class="text-success">destinatie</strong>';
$L1['facility_info_section_title/html'] = 'Informatii <strong>Destinatie</strong>';
