...
themeFunctions::loadLang('travelfuse_tours');
$L1['meta_title'] = 'Circuit Travelfuse ' . lang('append_title');
$L1['page_title/html'] = '<span>Informatii</span> <strong class="text-success">circuit</strong>';
$L1['hotel_info_section_title/html'] = 'Informatii <strong>Circuit</strong>';
