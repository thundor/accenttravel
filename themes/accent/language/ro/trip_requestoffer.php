...
$L1['meta_title'] = 'Cereri oferta' . lang('append_title');
$L1['page_title/html'] = '<span>Cereri</span> <strong class="text-success">Oferte</strong>';
themeFunctions::loadLang('general/actions');
themeFunctions::loadLang('general/options');
$L1['requestoffer_list/html'] = 'Listă <strong>cereri</strong>';
$L1['requestoffer_permissions/html'] = '<i class="fa fa-check-square-o"></i> <span>Permisiuni în această zonă</span>';
$L1['confirm_delete'] = 'Sunteți sigur că doriți ștergerea acestei cereri?';
$L1['th_title'] = "Titlu";
$L1['th_email'] = "Email";
$L1['th_phone'] = "Telefon";
$L1['th_fullname'] = "Nume";
