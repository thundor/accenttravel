...
<?php themeFunctions::loadLang('newsletter_subscribers'); ?>
<?php themeFunctions::includeAddon('sweetalert'); ?>
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/subscribers/scripts.php'); ?>
<?php themeFunctions::addIncludePath('layouts/backend/default/headbar/page_actions.php', __DIR__ . '/subscribers/page_actions.php'); ?>
<?php themeFunctions::addIncludePath('modules/backend/headbar/page_title.php', __DIR__ . '/subscribers/page_title.php'); ?>
<?php themeFunctions::addIncludePath('modules/head/meta.php', __DIR__ . '/subscribers/meta.php'); ?>
<?php themeFunctions::addIncludePath('includes/head/stylesheets.php', __DIR__ . '/subscribers/stylesheets.php'); ?>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h2 class="h5 display"><?php echo lang('subscribers_list/html'); ?></h2>
          </div>
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered Newsletter_Subscribers_table">
              <thead>
                <tr>
                  ...
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_account'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_status'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_date'); ?></th>
