...
;(function($){
  ...
  var $sliders_homepage_form = $('#sliders_homepage_form');
  ...
  applyZoneEffects($sliders_homepage_form);
  $sliders_homepage_form.on('click', '#homepage_add_zone', function(e){
    e.preventDefault();
    console.log('click', this);
    var $new_tr = $('#sliders_homepage_form_models > div').clone();
    ...
    return false;
  }).on('click', '.homepage-remove-zone', function(e){
    e.preventDefault();
    console.log('click', this);
