...
;(function($){
  ...
  var $sliders_heroslider_form = $('#sliders_heroslider_form');
  ...
  applyZoneEffects($sliders_heroslider_form);
  $sliders_heroslider_form.on('click', '#heroslider_add_zone', function(e){
    e.preventDefault();
    console.log('click', this);
    var $new_tr = $('#sliders_heroslider_form_models > div').clone();
    ...
    return false;
  }).on('click', '.heroslider-remove-zone', function(e){
    e.preventDefault();
    console.log('click', this);
