...
;(function($){
  ...
  var $sliders_homebackground_form = $('#sliders_homebackground_form');
  function applyZoneEffects($container){
  }
  $('.sliders-sortable').sortable({
    revert: true,
    items: ">.sliders-sortable-item",
    handle: ".move-offer",
    start: function(e, ui){
  ...
  applyZoneEffects($sliders_homebackground_form);
  $sliders_homebackground_form.on('click', '#homebackground_add_zone', function(e){
    e.preventDefault();
    console.log('click', this);
    var $new_tr = $('#sliders_homebackground_form_models > div').clone();
    ...
    return false;
  }).on('click', '.homebackground-remove-zone', function(e){
    e.preventDefault();
    console.log('click', this);
