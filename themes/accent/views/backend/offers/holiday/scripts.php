...
;(function($){
  ...
  var $offers_holiday_form = $('#offers_holiday_form');
  ...
  applyZoneEffects($offers_holiday_form);
  $offers_holiday_form.on('click', '#holiday_add_zone', function(e){
    e.preventDefault();
    console.log('click', this);
    var $new_tr = $('#offers_holiday_form_models > div').clone();
    ...
    return false;
  }).on('click', '.holiday-remove-zone', function(e){
    e.preventDefault();
    console.log('click', this);
