        ...
        <div class="form-group row">
          ...
          <div class="<?php echo $value_class; ?>">
            ...
            <label class="input-group mb-0">
              <input id="profile_birth_date" maxlength="10" type="text" name="birth_date" placeholder="<?php echo lang('birth_date_field_placeholder'); ?>" class="form-control input-birth_date" value="<?php echo htmlspecialchars($birth_date); ?>" />
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <?php if($can_write){ ?>
                      <select form="profileFellowEdit" id="fellow_edit_title" name="fellow_title" class="form-control">
                        <option value="">Alege</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <?php if($can_write){ ?>
                      <input form="profileFellowEdit" id="fellow_edit_firstname" maxlength="255" type="text" name="fellow_firstname" placeholder="<?php echo lang('firstname_field_placeholder'); ?>" class="form-control" value="" required />
                      <?php } else { ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <?php if($can_write){ ?>
                      <input form="profileFellowEdit" id="fellow_edit_lastname" maxlength="255" type="text" name="fellow_lastname" placeholder="<?php echo lang('lastname_field_placeholder'); ?>" class="form-control" value="" />
                      <?php } else { ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <?php if($can_write){ ?>
                      <input form="profileFellowEdit" id="fellow_edit_birth_date" maxlength="10" type="text" name="fellow_birth_date" placeholder="<?php echo lang('birth_date_field_placeholder'); ?>" class="form-control input-birth_date" value="" required />
                      <?php } else { ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <?php if($can_write){ ?>
                      <select form="profileFellowEdit" id="fellow_edit_country" name="fellow_country" class="form-control">
                        <option value="">Alege</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <?php if($can_write){ ?>
                      <input form="profileFellowEdit" id="fellow_edit_passport_number" maxlength="255" type="text" name="fellow_passport_number" placeholder="Numar pasaport" class="form-control" value="" />
                      <?php } else { ?>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <select form="profileFellowAdd" id="fellow_add_title" name="fellow_title" class="form-control">
                        <option value="">Alege</option>
                        <?php themeFunctions::loadModule('helpers/titles/select_option',__FILE__ . '/passenger_title_options'); ?>
                        <?php themeFunctions::loadAddons(__FILE__ . '/passenger_title_options'); ?>
                      </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <input form="profileFellowAdd" id="fellow_add_firstname" maxlength="255" type="text" name="fellow_firstname" placeholder="<?php echo lang('firstname_field_placeholder'); ?>" class="form-control" value="" required />
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="fellow_add_lastname" class="<?php echo $label_class; ?>"><?php echo lang('lastname_field_label/html'); ?></label>
                    <div class="<?php echo $value_class; ?>">
                      <input form="profileFellowAdd" id="fellow_add_lastname" maxlength="255" type="text" name="fellow_lastname" placeholder="<?php echo lang('lastname_field_placeholder'); ?>" class="form-control" value="" />
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="fellow_add_birth_date" class="<?php echo $label_class; ?>"><?php echo lang('birth_date_field_label/html'); ?></label>
                    <div class="<?php echo $value_class; ?>">
                      <input form="profileFellowAdd" id="fellow_add_birth_date" maxlength="10" type="text" name="fellow_birth_date" placeholder="<?php echo lang('birth_date_field_placeholder'); ?>" class="form-control input-birth_date" value="" required />
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="fellow_add_country" class="<?php echo $label_class; ?>">Nationalitate</label>
                    <div class="<?php echo $value_class; ?>">
                      <select form="profileFellowAdd" id="fellow_add_country" name="fellow_country" class="form-control">
                        <option value="">Alege</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="<?php echo $value_class; ?>">
                      <input form="profileFellowAdd" id="fellow_add_passport_number" maxlength="255" type="text" name="fellow_passport_number" placeholder="Numar pasaport" class="form-control" value="" />
                    </div>
                  </div>
                <p class="text-danger">Dupa adaugare, nu uitati sa dati clic pe butonul de Salvare</p>
              </div>
              <div class="modal-footer">
                <button form="profileFellowAdd" type="submit" form="profileFellowAdd" class="btn btn-success"><i class="fa fa-plus"></i> Adaugare</button>
              </div>
            </div>
          </div>
        </div>
