...
<li class="nav-item">
  <div class="btn-group">
    <?php
    if($this->_ci->user->can('backend-cms-layouts-add')) { ?>
    <a href="<?php echo site_url('backend/cms/layouts/add'); ?>" class="btn btn-success">
    ...
    <div class="dropdown btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="permissions_button">
        <a href="<?php echo site_url('backend/accounts/roles?path=backend-cms-layouts'); ?>" class="dropdown-item">
          <?php echo lang('cms_layouts_permissions/html'); ?>
        </a>
      </div>
    </div>
    <?php } ?>
