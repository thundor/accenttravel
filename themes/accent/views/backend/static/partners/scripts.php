...
;(function($){
  ...
  var $static_partners_form = $('#static_partners_form');
  ...
  applyZoneEffects($static_partners_form);
  $static_partners_form.on('click', '#partners_add_zone', function(e){
    e.preventDefault();
    console.log('click', this);
    var $new_tr = $('#static_partners_form_models > div').clone();
    ...
    return false;
  }).on('click', '.partners-remove-zone', function(e){
    e.preventDefault();
    console.log('click', this);
