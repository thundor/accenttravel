...
<?php themeFunctions::loadLang('trip_blockemails'); ?>
<?php themeFunctions::includeAddon('sweetalert'); ?>
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/blockemails/scripts.php'); ?>
<?php themeFunctions::addIncludePath('layouts/backend/default/headbar/page_actions.php', __DIR__ . '/blockemails/page_actions.php'); ?>
<?php themeFunctions::addIncludePath('modules/backend/headbar/page_title.php', __DIR__ . '/blockemails/page_title.php'); ?>
<?php themeFunctions::addIncludePath('modules/head/meta.php', __DIR__ . '/blockemails/meta.php'); ?>
<?php themeFunctions::addIncludePath('includes/head/stylesheets.php', __DIR__ . '/blockemails/stylesheets.php'); ?>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h2 class="h5 display"><?php echo lang('blockemails_list/html'); ?></h2>
          </div>
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered Trip_blockemails_table">
              <thead>
                <tr>
                  ...
                  <?php /*<th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_percentage'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_max_uses'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_nr_uses'); ?></th>
