...
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/service_hotel/search_scripts.php'); ?>
<?php 
$start_date = '';
        ...
        <div class="card rounded-0">
          ...
          <div id="serviceHotelFormContainer" class="collapse show" role="tabpanel" aria-labelledby="serviceHotelFormHeader">
            <div class="card-block p-1">
              <form id="serviceHotelForm" name="serviceHotelForm" action="<?php echo site_url('backend/trip/hotels/setSearch'); ?>" method="POST" onsubmit="return false;">
                ...
                <?php } ?>
                <input type="hidden" id="service_hotel_search_city_id" name="city_id" value="<?php echo htmlspecialchars($this->hotel_search_data['city_id']); ?>"/>
                <input type="hidden" id="service_hotel_search_city_name" value="<?php echo htmlspecialchars($this->hotel_search_data['city_name']); ?>" />
                <input type="hidden" id="service_hotel_search_country_id" name="country_id" value="<?php echo htmlspecialchars($this->hotel_search_data['country_id']); ?>"/>
                <input type="hidden" id="service_hotel_search_country_name" name="country_name" value="<?php echo htmlspecialchars($this->hotel_search_data['country_name']); ?>"/>
                <div class="row no-gutters">
                  <div class="form-group col-12 col-sm-6 mb-1 has-danger">
                    <label class="input-group mb-0">
                      <input type="text" maxlength="255" class="form-control" name="city_name" id="service_hotel_search_city" placeholder="Oras" required  value="<?php echo htmlspecialchars($this->hotel_search_data['city_name']); ?>"/>
                  ...
                  <div class="form-group col-12 col-sm-6 mb-1 pl-sm-1">
                    <label class="input-group mb-0">
                      <input type="text" maxlength="255" class="form-control" name="hotel_name" id="service_hotel_search_hotel_name" placeholder="Nume hotel" value="<?php echo htmlspecialchars($this->hotel_search_data['hotel_name']); ?>" />
                      <span class="input-group-addon adjust-addon-width">
                  ...
                  <div class="form-group col-12 col-sm-6 mb-1 has-danger">
                    <label class="input-group mb-0">
                      <input type="text" maxlength="255" class="form-control" name="start_date" id="service_hotel_search_checkin" placeholder="Check-in" required value="<?php echo htmlspecialchars($start_date); ?>" />
                      <span class="input-group-addon adjust-addon-width">
                  ...
                  <div class="form-group col-12 col-sm-6 mb-1 pl-sm-1 has-danger">
                    <label class="input-group mb-0">
                      <input type="text" maxlength="255" class="form-control" name="end_date" id="service_hotel_search_checkout" placeholder="Check-out" required value="<?php echo htmlspecialchars($end_date); ?>" />
                      <span class="input-group-addon adjust-addon-width">
                ...
                <div id="service_hotel_search_rooms_citybreak">
                </div>
              ...
              <div id="service_hotel_search_rooms_table_outside_container" style="display:none;">
                <div id="service_hotel_search_rooms_citybreak_hidden_inputs"></div>
              </div>
            </div>
          </div>
        </div>
        <div id="result_serviceHotelForm" class="form-group mb-1"></div>
        <div class="form-group mb-1 has-warning" data-toggle="tooltip" title="Odata activat, hotelul ales va fi depozitat in tab-ul CityBreak" style="display:none;">
          <label class="input-group mb-0">
            <span class="input-group-addon mb-0">
              <input type="checkbox" id="service_hotel_citybreak" value="1" checked>
            </span>
      ...
      <div id="serviceHotelFormFellowsFormWrapper" class="col-12 col-lg-6 col-xl-12" style="display:none">
        <div class="card rounded-0">
          ...
          <div id="serviceHotelFormFellowsFormContainer" class="collapse show" role="tabpanel" aria-labelledby="serviceHotelFormFellowsFormHeader">
            <div class="card-block p-1">
              <form id="serviceHotelFormFellowsForm" name="serviceHotelFormFellowsForm" action="<?php echo site_url('backend/trip/orders/addHotelService'); ?>" method="POST" onsubmit="return false;">
                ...
                <div id="service-hotel-room-packages-loading" class="alert room-packages-loading alert-warning mb-0 fade show" role="alert" style="display:none;">
                  <div class="alert-message">Se incarca pachetele ... <i class="fa fa-spinner fa-spin"></i></div>
                </div>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-xl-4 mb-1 pl-xl-1">
                <div class="card rounded-0">
                  ...
                  <div class="card-block">
                    <div id="hotel-services-search-filter-activitycategories" class="hotel-filter hotel-activitycategories-filter">
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 mb-1">
                <div class="card rounded-0">
                  ...
                  <div class="card-block">
                    <div id="hotel-services-search-filter-pois" class="hotel-filter hotel-pois-filter">
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 mb-1 pl-xl-1">
                <div class="card rounded-0">
                  ...
                  <div class="card-block">
                    <div id="hotel-services-search-filter-facilities" class="hotel-filter hotel-facilities-filter">
                    </div>
                  </div>
                </div>
              </div>
...
<div id="hotel-models" style="display:none;">
  ...
  <div id="hotel-room-fellow-adult-model" class="hotel-room-fellow hotel-room-fellow-adult card">
    ...
    <div class="card-block room-fellow-info pt-1 pl-0 pr-1 pb-0">
      <div class="row ml-0 mr-0">
        <?php /* <div class="form-group col-sm-6 mb-1 pl-1 pr-0">
          <label class="input-group mb-0">
            <input type="text" maxlength="10" class="form-control passenger-birth_date" placeholder="Data nasterii" required />
            <span class="input-group-addon adjust-addon-width">
              <i class="fa fa-calendar"></i>
  ...
  <div id="hotel-result-model" class="hotel-result card mb-2">
    <div class="card-header pt-1 pb-1 pl-2 pr-2 d-flex align-items-center justify-content-between">
      <input type="hidden" name="hotel_id" class="hotel-id" />
    ...
    <div class="card-block p-1">
          ...
          <h4 class="mt-0 mb-0 d-flex align-items-center justify-content-between">
            ...
            <span class="text-center">
              <button type="button" class="ml-2 room-options-toggle btn btn-success">
                <i class="fa fa-cubes"></i><span class="hidden-sm-down"> Pachete disponibile</span>
              </button>
              <?php /*
              <br />
              <span>
                <i class="fa fa-clock-o"></i>
                <small class="hotel-expiration"></small>
              </span>
              */ ?>
            </span>
          </h4>
      ...
      <div class="hotel-result-accordion" role="tablist" aria-multiselectable="true">
        <div class="card rounded-0">
  ...
  <div id="hotel-room-packages-model" class="hotel-room-packages card">
    <a class="card-header d-flex align-items-center justify-content-between pt-1 pb-1 pl-2 pr-2 bg-inverse text-white collapsed nounderline" data-toggle="collapse" href="#" aria-expanded="false" role="tab">
      <span class="package-name"><i class="fa fa-cube"></i> Pachet #<strong class="package-number"></strong></span>
        ...
        <div class="form-group package-toggle m-1">
          <div class="custom-controls-stacked d-block">
            <label class="custom-control custom-radio d-block mb-0 mr-0">
              ...
              <span class="custom-control-description"><i class="fa fa-cube"></i> Utilizeaza acest pachet</span>
            </label>
          </div>
        </div>
      </div>
  ...
  <div id="hotel-room-package-room-model" class="hotel-room-package-room card">
  ...
  <label id="hotel-room-package-room-option-model" class="hotel-room-package-room-option btn btn-block btn-secondary d-flex align-items-center justify-content-start pt-0 pb-0 pl-1 pr-0 mt-0 mb-1" style="cursor:pointer;">
