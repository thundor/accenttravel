...
<li class="nav-item">
  <div class="btn-group">
    ...
    <button type="submit" disabled form="couponsForm" value="save_and_back" class="btn btn-success">
    ...
    <div class="dropdown btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <?php if($can_edit){ ?>
        <button disabled type="submit" form="couponsForm" value="apply" class="dropdown-item">
          <?php echo lang('action_apply/html'); ?>
        </button>
        <?php } ?>
        <a href="<?php echo site_url('backend/trip/coupons'); ?>" class="dropdown-item">
          <?php echo lang('action_back_to_list/html'); ?>
        </a>
      </div>
    </div>
    <?php } else { ?>
    <a href="<?php echo site_url('backend/trip/coupons'); ?>" class="btn btn-secondary">
      <?php echo lang('action_back_to_list/html'); ?>
    </a>
    <?php if($can_edit){ ?>
    <div class="dropdown btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <?php if($can_edit){ ?>
        <a href="<?php echo site_url('backend/trip/coupons/edit?id=' . $coupon->id); ?>" class="dropdown-item">
