...
<?php themeFunctions::loadLang('trip_list_orders'); ?>
          ...
          <div class="card-block">
            <div class="row">
              ...
              <div class="col-lg-12 col-md-6">
				<div class="input-group-btn dropdown float-left">
            ...
            <table class="table-responsive table table-striped table-hover table-bordered Trip_<?php echo $this->_controller; ?>_table">
              <thead>
                <?php /* 
                <?php $col_count = 0; ?>
                <tr>
                  <th colspan="4" class="tbl-col-h-<?php echo ++$col_count;?> text-center" style="width:1%;">
                    <?php echo lang('th_order'); ?>
                  </th>
                  <th colspan="2" class="tbl-col-h-<?php echo ++$col_count;?> text-center"><?php echo lang('th_client'); ?></th>
                  <th colspan="3" class="tbl-col-h-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_created'); ?></th>
                  <th rowspan="2" class="tbl-col-h-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_actions'); ?></th>
                </tr>
                */ ?>
                <?php $col_count = 0; ?>
                <tr>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;">
                    <?php echo lang('th_order_id'); ?>
                  </th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_provider'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_trip_id'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_status'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_type'); ?></th>
                  
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:20%;"><?php echo lang('th_name'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:20%;"><?php echo lang('th_email'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_payment_method'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_price'); ?></th>
                  
                  <?php /* 
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:20%;"><?php echo lang('th_name'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:20%;"><?php echo lang('th_email'); ?></th>
                  */ ?>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:15%;"><?php echo lang('th_created_time'); ?></th>
