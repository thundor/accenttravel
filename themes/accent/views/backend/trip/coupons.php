...
<?php themeFunctions::loadLang('trip_coupons'); ?>
<?php themeFunctions::includeAddon('twigjs'); ?>
<?php themeFunctions::includeAddon('sweetalert'); ?>
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/coupons/scripts.php'); ?>
<?php themeFunctions::addIncludePath('layouts/backend/default/headbar/page_actions.php', __DIR__ . '/coupons/page_actions.php'); ?>
<?php themeFunctions::addIncludePath('modules/backend/headbar/page_title.php', __DIR__ . '/coupons/page_title.php'); ?>
<?php themeFunctions::addIncludePath('modules/head/meta.php', __DIR__ . '/coupons/meta.php'); ?>
<?php themeFunctions::addIncludePath('includes/head/stylesheets.php', __DIR__ . '/coupons/stylesheets.php'); ?>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h2 class="h5 display"><?php echo lang('coupons_list/html'); ?></h2>
          </div>
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered Trip_Coupons_table">
              <thead>
                <tr>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_id'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_code'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">EAN</th>
                  ...
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">Pentru</th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">Discount</th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">Utilizari</th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">Valabilitate</th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">Comenzi</th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center">Servicii</th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_actions'); ?></th>
                </tr>
              </thead>
              <tbody id="serii-cupoane-tbody"></tbody>
            </table>
          </div>
        </div>
      </div>
