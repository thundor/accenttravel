...
<li class="nav-item">
  <div class="btn-group">
    <?php
    /* if($this->_ci->user->can('backend-config-add')) { ?>
    <a href="<?php echo site_url('backend/newsletter/subscribers/add'); ?>" class="btn btn-success">
      <?php echo lang('action_add/html'); ?>
    </a>
    <?php } */ ?>
    <?php
   /*  if($this->_ci->user->can('backend-config-access')) { ?>
    <a href="<?php echo site_url('backend/newsletter/subscribers/export'); ?>" class="btn btn-success">
      <?php echo lang('action_export/html'); ?>
    </a>
    <?php } */ ?>
    <?php if($this->_ci->user->canAnyUnder('backend-accounts-roles-access')) { ?>
    <?php /* <div class="dropdown btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="permissions_button">
        <a href="<?php echo site_url('backend/accounts/roles?path=backend-config'); ?>" class="dropdown-item">
          <?php echo lang('notifications_permissions/html'); ?>
        </a>
      </div>
    </div> */ ?>
    <?php } ?>
