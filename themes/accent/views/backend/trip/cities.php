...
<?php themeFunctions::loadLang('trip_cities'); ?>
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/cities/scripts.php'); ?>
<?php themeFunctions::addIncludePath('layouts/backend/default/headbar/page_actions.php', __DIR__ . '/cities/page_actions.php'); ?>
<?php themeFunctions::addIncludePath('modules/backend/headbar/page_title.php', __DIR__ . '/cities/page_title.php'); ?>
<?php themeFunctions::addIncludePath('modules/head/meta.php', __DIR__ . '/cities/meta.php'); ?>
<?php themeFunctions::addIncludePath('includes/head/stylesheets.php', __DIR__ . '/cities/stylesheets.php'); ?>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h2 class="h5 display"><?php echo lang('cities_list/html'); ?></h2>
          </div>
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered trip_cities_table">
              <thead>
                <tr>
