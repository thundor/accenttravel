...
<?php themeFunctions::loadLang('trip_flight_airlines'); ?>
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/airlines/scripts.php'); ?>
<?php themeFunctions::addIncludePath('layouts/backend/default/headbar/page_actions.php', __DIR__ . '/airlines/page_actions.php'); ?>
<?php themeFunctions::addIncludePath('modules/backend/headbar/page_title.php', __DIR__ . '/airlines/page_title.php'); ?>
<?php themeFunctions::addIncludePath('modules/head/meta.php', __DIR__ . '/airlines/meta.php'); ?>
<?php themeFunctions::addIncludePath('includes/head/stylesheets.php', __DIR__ . '/airlines/stylesheets.php'); ?>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h2 class="h5 display"><?php echo lang('airlines_list/html'); ?></h2>
          </div>
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered trip_flight_airlines_table">
              <thead>
                <tr>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_code'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_name'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_image'); ?></th>
