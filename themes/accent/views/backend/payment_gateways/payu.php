...
<?php themeFunctions::addIncludePath('includes/body/scripts.php', __DIR__ . '/payu/scripts.php'); ?>
...
<?php themeFunctions::addIncludePath('layouts/backend/default/headbar/page_actions.php', __DIR__ . '/payu/page_actions.php'); ?>
<?php themeFunctions::addIncludePath('modules/backend/headbar/page_title.php', __DIR__ . '/payu/page_title.php'); ?>
<?php 
$label_size = array();
$label_size['xl'] = 3;
$label_size['lg'] = 4;
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-block">
            <div id="result_payuForm" class="form-group" ></div>
            <form id="payuForm" name="payuForm" class="payment_gateway_settings" action="<?php echo site_url('backend/payment_gateways/payu/save'); ?>" method="POST">
              ...
              <div class="form-group row">
                ...
                <div class="<?php echo $value_class; ?>">
                  <div class="form-control" readonly><?php echo htmlspecialchars(site_url('/trip/checkout/payu/ipn')); ?></div>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="<?php echo $value_class; ?>">
                  <?php if($can_write){ ?>
                  <div class="i-checks">
                    <input id="status_inactive" type="radio" value="0" name="payu_status" <?php echo !$data['payu_status'] ? 'checked' : ''; ?> class="form-control-custom radio-custom">
                    <label for="status_inactive"><?php echo lang('option_inactive'); ?></label>
                  </div>
                  <div class="i-checks">
                    <input id="status_live" type="radio" value="1" name="payu_status" <?php echo $data['payu_status'] === 1 ? 'checked' : ''; ?> class="form-control-custom radio-custom">
                    <label for="status_live">Live</label>
                  </div>
                  <div class="i-checks">
                    <input id="status_test_public" type="radio" value="-1" name="payu_status" <?php echo $data['payu_status'] === -1 ? 'checked' : ''; ?> class="form-control-custom radio-custom">
                    <label for="status_test_public">Sandbox(privat)</label>
                  </div>
                  <div class="i-checks">
                    <input id="status_test_privat" type="radio" value="-2" name="payu_status" <?php echo $data['payu_status'] === -2 ? 'checked' : ''; ?> class="form-control-custom radio-custom">
                    <label for="status_test_privat">Sandbox(public)</label>
                  </div>
                  <?php } else { ?>
                  <div class="form-control" readonly><?php echo $data['payu_status'] < 0 ? 'Sandbox(' . ($data['payu_status'] == -1 ? 'privat' : 'public') . ')' : ($data['payu_status'] == 1 ? 'Live' : lang('option_inactive')); ?></div>
                  <?php } ?>
                  <?php if($can_write){ ?>
              ...
              <div class="form-group row">
                ...
                <div class="<?php echo $value_class; ?>">
                  ...
                  <div class="input-group">
                    <input type="text" name="payu_merchant_id" placeholder="Merchant Integration Code" class="form-control" value="<?php echo htmlspecialchars($data['payu_merchant_id']); ?>" <?php echo $data['payu_status'] ? 'required' : ''; ?>/>
                  </div>
                  <?php } else { ?>
                  <div class="form-control" readonly><?php echo htmlspecialchars($data['payu_merchant_id']); ?>&nbsp;</div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="<?php echo $value_class; ?>">
                  <?php if($can_write){ ?>
                  <div class="input-group">
                    <input type="text" name="payu_secret_key" placeholder="Secret Key" class="form-control" value="<?php echo htmlspecialchars($data['payu_secret_key']); ?>" <?php echo $data['payu_status'] ? 'required' : ''; ?>/>
                  </div>
                  <?php } else { ?>
                  <div class="form-control" readonly><?php echo htmlspecialchars($data['payu_secret_key']); ?>&nbsp;</div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="<?php echo $value_class; ?>">
                  <?php if($can_write){ ?>
                  <select name="payu_payment_methods[]" class="form-control" multiple size="17">
