      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h2 class="h5 display"><?php echo lang('' . basename(__FILE__, '.php') . '_list/html'); ?></h2>
          </div>
          <div class="card-block travelfuse_hotels_wrapper">
            <div class="row">
              <div class="col-xl-5 col-lg-5 col-md-6">
                <div class="input-group">
                  ...
                  <input type="search" class="form-control" name="country" id="country" placeholder="<?php echo lang('filter_country_placeholder'); ?>">
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered travelfuse_hotels_table">
              <thead>
                <tr>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center" style="width:1%;"><?php echo lang('th_id'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_country'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_name'); ?></th>
                  <th class="tbl-col-<?php echo ++$col_count;?> text-center"><?php echo lang('th_cities'); ?></th>
              ...
              <tbody id="travelfuse_hotels_tbody"></tbody>
            </table>
          </div>
        </div>
      </div>
