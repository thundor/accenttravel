...
<li class="nav-item">
  <div class="btn-group">
    ...
    <button type="submit" disabled form="facilitiesForm" value="save_and_back" class="btn btn-success">
    ...
    <div class="dropdown btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <?php if($can_edit){ ?>
        <button disabled type="submit" form="facilitiesForm" value="apply" class="dropdown-item">
          <?php echo lang('action_apply/html'); ?>
        </button>
        <?php } ?>
        <a href="<?php echo site_url('backend/travelfuse/travelfuse_facilities'); ?>" class="dropdown-item">
          <?php echo lang('action_back_to_list/html'); ?>
        </a>
      </div>
    </div>
    <?php } else { ?>
    <a href="<?php echo site_url('backend/travelfuse/travelfuse_facilities'); ?>" class="btn btn-secondary">
      <?php echo lang('action_back_to_list/html'); ?>
    </a>
    <?php if($can_edit){ ?>
    <div class="dropdown btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <?php if($can_edit){ ?>
        <a href="<?php echo site_url('backend/travelfuse/travelfuse_facilities/edit?id=' . $facility->id); ?>" class="dropdown-item">
