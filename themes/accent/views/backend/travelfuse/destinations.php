    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-block travelfuse_destinations_wrapper">
            <div class="row">
          ...
          $col_count = 0;
          ?>
            <table class="table-responsive table table-striped table-hover table-bordered travelfuse_destinations_table">
              <thead>
                <tr>
              ...
              <tbody id="travelfuse_destinations_tbody"></tbody>
            </table>
          </div>
        </div>
      </div>
