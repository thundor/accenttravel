...
<div class="row blockBack">
  <div class="col-sm-4  mt-3 pr-0">
    <p>
      <a href="<?php echo site_url('trip/citybreaksasync'); ?>" class="backToCat"><i class="fa fa-caret-left mt-1"></i> Inapoi la oferte City Break <?php echo $data['destination_city_name']; ?></a>
    </p>
  </div>
  <div class="col-sm-4  mt-3 pr-0 pl-0 text-center">
     ...
     <i class="fa fa-chevron-down"></i> 
     <a href="#infoZbor"  class="backToCat">info Zbor</a>
   </div>
