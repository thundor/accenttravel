      ...
      <div class="col-12">
        ...
        */ ?>
        <p class="pretHotPag pt-sm-4 text-right" style="visibility:hidden;">
          ...
          <button id="top_booking_button" type="submit" form="Package-1" class="btn btn-success">REZERVA</button>
        </p>
      </div>
      <div class="col-12">
...
<div id="package_selector_wrapper" style="display:none;">
...
<form id="package-model" class="hotel-package form-validate card" action="<?php echo site_url('trip/hotel/booking/' . $data['hotel_id']); ?>" method="POST" style="display:none;">
...
<div class="row mt-4">
  <div class="col-12">
    ...
    <p><?php echo nl2br(isset($hotel_details->FullDesc) && strlen($hotel_details->FullDesc)? $hotel_details->FullDesc : $hotel_details->ShortDesc); ?></p> 
    <div>
  ...
  <div class="col-12 mb-3" id="iconsFacilitati">
    ...
    <p id="facilitatiHotelDesc" class="text-hide"><?php 
      ...
      echo implode(', ', $hotel_details->FacilitiesDetail); 
    ?></p>
  </div>
