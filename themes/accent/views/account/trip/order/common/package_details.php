...
<ul>
        ...
        <ol>
          ...
          <?php 
            ...
            foreach($guest_extra_services_ids as $guest_extra_services_id){
              ...
              <li><?php echo $extra_service->Name ?> <b><?php echo $extra_service->Mandatory ? 'inclus' : 'ales'; ?></b></li><?php
            } ?>
            </ul><?php
            } ?>
          </li><?php
  ...
  <li>Servicii extra comune:
    <ul>
      ...
      <li><?php echo $extra_service->Name ?> <b><?php echo $extra_service->Mandatory ? 'inclus' : 'ales'; ?></b></li>
      <?php } ?>
    </ul>
  </li>
</ul>
