...
<ul>
  ...
  <li>Check-in: <b><?php echo $service['checkin']; ?></b></li>
  <li>Check-out: <b><?php echo $service['checkout']; ?></b></li>
...
<ul><?php 
  foreach($service['cancellation_policies'] as $room_cancellation_policies){
    ...
    <li>Dupa data <?php echo $cancellation_date->format('d.m.Y h:i:s A'); ?> se inpune o taxa aditionala de <?php echo $cancellation_price_formatted; ?></li><?php     
      }
    }
  } ?>
</ul>
