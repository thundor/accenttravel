...
<form id="package-model" class="hotel-package card" action="<?php echo site_url('paralela45/strainatate/booking/' . $data['hotel_code']); ?>" method="POST" style="display:none;">
  ...
  <?php } ?>
  <input name="offer_start_date" value="" type="hidden" />
  <input name="offer_end_date" value="" type="hidden" />
  <input name="offer_id" value="" type="hidden" />
  <input name="offer_variant_id" value="" type="hidden" />
  <input name="offer_origin" value="" type="hidden">
