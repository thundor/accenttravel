...
$checkin_date = DateTime::createFromFormat('Y-m-d H:i:s', $this->view_data['checkin']);
$checkout_date = DateTime::createFromFormat('Y-m-d H:i:s', $this->view_data['checkout']);
...
<div class="row">
  <div class="col-12 col-sm-6 mt-<?php echo $mt; ?>">
    <h3 class=" subTitleFilter pl-0">Detalii Rezervare Circuit</h3>
    <ul class="list-unstyled">
      ...
      <li><i class="fa fa-moon-o greenCTA"></i> Durata circuit: <?php echo $nights_formatted; ?> zile</li>
      <?php 
  ...
  if($offer->Services) { ?>
    <h3 class=" subTitleFilter pl-0">Servicii Incluse Circuit</h3>
