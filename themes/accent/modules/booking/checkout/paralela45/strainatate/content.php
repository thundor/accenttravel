...
<form id="bookingCheckout" name="bookingCheckout" action="<?php echo site_url('paralela45/strainatate/checkout'); ?>" method="POST" onsubmit="return false;">
<input type="hidden" name="offer_id" value="<?php echo $data['offer_id']; ?>" />
<input type="hidden" name="departure_city_code" value="<?php echo $data['departure_city_code']; ?>" />
<input type="hidden" name="destination_city_code" value="<?php echo htmlspecialchars($data['destination_city_code']); ?>" />
<input type="hidden" name="package_id" value="<?php echo htmlspecialchars($data['package_id']); ?>" />
<input type="hidden" name="package_variant_id" value="<?php echo htmlspecialchars($data['package_variant_id']); ?>" />
<input type="hidden" name="product_code" value="<?php echo htmlspecialchars($data['product_code']); ?>" />
<input type="hidden" name="checkin" value="<?php echo htmlspecialchars($data['checkin']); ?>" />
<input type="hidden" name="checkout" value="<?php echo htmlspecialchars($data['checkout']); ?>" />
