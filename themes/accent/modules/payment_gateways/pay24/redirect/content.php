...
$pay24_status = (int)$this->_ci->Options_model->get('payment_gateways_status','pay24',0);
...
$payment_method = $this->view_data['pay24_payment_method'];

$hidden_inputs = array();
$hidden_inputs['MERCHANT'] = $settings['pay24_merchant_id'];
...
$hidden_inputs['ORDER_HASH'] = hash_hmac('md5',$signature,$settings['pay24_secret_key']);
$url .= 'order/lu.php';
$hidden_inputs['POST_URL'] = $url;
?>

<h1>24 PAY - Formular Ascuns</h1>

<form id="onlineForm" name="onlineForm" action="<?php echo $url?>" method="POST">
  <?php 
...
<pre>
<?php echo json_encode($processor_data, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>
</pre>
