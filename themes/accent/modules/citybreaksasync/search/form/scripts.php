...
(function($){
    ...
    if(citybreak_search_data.occupancy.length){
      my_obj.o = citybreak_search_data.occupancy;
		...
		var filters_link = 'trip/citybreaksasync/?' + recursiveDecoded;
  ...
  $("#dateZborCB").caleran({
    ...
    singleDate: true,
    locale: 'ro',
    startEmpty: citybreak_search_data.start_date === '',
    showFooter: false,
    autoCloseOnSelect: true,
    format: 'DD/MM/Y',
    minDate: moment().startOf('day'),
    startDate: moment(citybreak_search_data.start_date,'Y-MM-DD'),
    endDate: moment(citybreak_search_data.start_date,'Y-MM-DD'),
    onafterselect: function(caleran, startDate, endDate){
      if(!caleran.globals.firstValueSelected){
        return;
      }
      citybreak_search_data.start_date = endDate.format("Y-MM-DD");
  ...
  $("#dateZborCB2").caleran({
    ...
    singleDate: true,
    locale: 'ro',
    startEmpty: citybreak_search_data.end_date === '',
    showFooter: false,
    autoCloseOnSelect: true,
    format: 'DD/MM/Y',
    minDate: moment().startOf('day'),
    startDate: moment(citybreak_search_data.end_date,'Y-MM-DD'),
...
function setSearchAndRedirect(){
  ...
  console.log(citybreak_search_data);
  $.ajax({
    url: '<?php echo site_url('trip/citybreaksasync/setSearch'); ?>',
    method: 'post',
    dataType: 'json',
    ...
    success: function(result,status,xhr){
      ...
      window.location.href="<?php echo site_url('trip/citybreaksasync/search'); ?>";
    },
