...
<div class="col-sm-12 " id="cam<?php echo $room; ?>Hotel" <?php echo $room_data ? 'style="display:block"' : ''; ?>>
  <div class="row">
    <div class="col-sm-12 col-md-2 col-lg-1"><p class="roomHotel">Camera <?php echo $room; ?></p></div>
    <div class="form-group col-sm-12 col-md-3 col-lg-2">
      <select class="form-control form-control-lg" id="adultiCam<?php echo $room; ?>">
    ...
    <div class="form-group col-sm-12 col-md-3 col-lg-2">
      <select class="form-control form-control-lg" id="copiiCam<?php echo $room; ?>">
    ...
    <div class="form-group col-sm-12 col-md-12 col-lg-7 varsteCopii" <?php echo $children ? 'style="display:block;"' : ''; ?>>
      <div class="form-group float-left">
        <p id="v1Cam<?php echo $room; ?>" <?php echo $children ? 'style="display:block;"' : ''; ?>>Varsta Copil 1</p>
        <select class="form-control form-control-lg" id="varstaCop1Cam<?php echo $room; ?>" <?php echo $children ? 'style="display:block;"' : ''; ?>>
      ...
      <div class="form-group float-left">
        <p id="v2Cam<?php echo $room; ?>" <?php echo $children==2 ? 'style="display:block;"' : 'style="display:none;"'; ?>>Varsta Copil 2</p>
        <select class="form-control form-control-lg" id="varstaCop2Cam<?php echo $room; ?>" <?php echo $children==2 ? 'style="display:block;"' : 'style="display:none;"'; ?>>
    ...
    <div class="form-group col-sm-4 col-md-2 col-lg-2" <?php echo $has_next_room ? 'style="display:none;"' : ''; ?>>
      <p id="addCam<?php echo $room+1; ?>" ><i class="fa fa-plus"></i> Adauga camera</p>
    </div>
    <?php } ?>
    <?php if($room>1) { ?>
    <div class="form-group col-sm-4 col-md-2 col-lg-2 <?php echo $room==$max_rooms ? 'offset-md-2 offset-lg-2' : ''; ?>" <?php echo $has_next_room ? 'style="display:none;"' : ''; ?>>
      <p id="remCam<?php echo $room; ?>"><i class="fa fa-minus"></i> Sterge camera</p>
    </div>
    <?php } ?>
  </div>
</div>
