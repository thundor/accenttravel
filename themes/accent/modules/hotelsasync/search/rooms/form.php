...
<form action="#" class="hotel-search">
  <div class="row">
    ...
    <div class="form-group col-sm-12 col-md-6">
      <input type="text" class="form-control form-control-lg" id="dateHotel" placeholder="Data checkin" required>
    </div>
    <div class="form-group col-sm-12 col-md-6">
      <input type="text" class="form-control form-control-lg" id="dateHotel2" placeholder="Data checkout" required>
    </div>
