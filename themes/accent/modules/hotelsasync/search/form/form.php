...
<div class="tab-pane active" id="hotel" role="tabpanel">
  <form action="#" method="post" class="hotel-search">
    <div class="row">
      ...
      <div class="form-group col-sm-12 col-md-6 col-lg-3">
        <input type="text" class="form-control form-control-lg" id="dateHotel" placeholder="Data plecare" required autocomplete="off" />
        <?php /* <input type="text" class="form-control form-control-lg" id="numeHotel" placeholder="Nume hotel (optional)" value="<?php echo htmlspecialchars($data['hotel_name']); ?>" /> */ ?>
      </div>
      <div class="form-group col-sm-12 col-md-6 col-lg-3">
        <input type="text" class="form-control form-control-lg" id="dateHotel2" placeholder="Data retur" required autocomplete="off" />
      </div>
      <div class="form-group col-sm-12 col-md-6 col-lg-3">
