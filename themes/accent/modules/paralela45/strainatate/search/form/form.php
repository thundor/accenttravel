...
<div class="tab-pane<?php echo $paralela45_special_layout ? ' active' : ''?>" id="abroadPax" role="tabpanel">
  <form action="#" method="post" class="pachete-strainatate-search">
    <div class="row">
      <div class="form-group col-sm-12 col-md-12 col-lg-4"> 
        <select id="taraPax1" class="form-control form-control-lg" name="taraPax1">
          <option value="" selected>Tara</option>
        </select>
      </div>
      <div class="form-group col-sm-12 col-md-12 col-lg-4"> 
        <select id="zonePax1" class="form-control form-control-lg" required name="zonePax1">
      ...
      <div class="form-group col-sm-12 col-md-12 col-lg-6"> 
        <select id="destinatiePax1" class="form-control form-control-lg" required name="destinatiePax1">
          <option value="" selected>Oras destinatie</option>
        </select>
      </div>
      ...
      <div class="form-group col-sm-12 col-md-4 col-lg-3">
        <select class="form-control form-control-lg" id="categPax1" required>
          <option value="">Numar nopti</option>
        </select>
      </div>
      <div class="form-group col-sm-12 col-md-4 col-lg-3">
        <input type="text" class="form-control form-control-lg" id="numeHotelPax1Abr" placeholder="Nume hotel (optional)">
      </div>
      ...
      <div class="col-sm-12" id="cam2Pax1">
        <div class="row">
          ...
          <div class="form-group col-sm-6 col-md-4 col-lg-2"><p id="addCam3Pax1"><i class="fa fa-plus"></i> Adauga camera</p></div>
          <div class="form-group col-sm-6 col-md-4 col-lg-2"><p id="remCam2Pax1"><i class="fa fa-minus"></i> Sterge camera</p></div>
        </div>
      </div>
      ...
      <div class="form-group col-12 col-md-8">
        <input type="text" class="form-control paralela45_strainatate_search_link" readonly />
      </div>
      <?php
      }
      ?>
      <div class="form-group col-12 col-sm-8 col-md-4">
        <button class="btn  btn-block btn-lg bg-primary" id="cautaPax1" name="cautaPax1"><i class="fa fa-search"></i> Cauta vacante</button>
      </div>
    </div>
  </form>
</div>
