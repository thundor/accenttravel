...
$static_settings = $this->_ci->Options_model->get('static_advantages_settings');
if(!$static_settings){
...
<div class="container">
  <div class="tematice">
    <div class="row">
      ...
      <h1 class="col-12 col-sm-12 col-md-6 col-lg-4">AVANTAJELE ACCENT</h1>
      <div class="col-0 col-sm-0 col-md-3 col-lg-4 borderTitle"></div>
      ...
      <div class="col-6 col-sm-4 partBan">
        <a href="<?php echo $url; ?>"><img data-toggle="tooltip" title="<?php echo htmlspecialchars($title); ?>" src="<?php echo $this->theme_url; ?>assets/images/advantages/<?php echo $image; ?>" alt="<?php echo htmlspecialchars($title); ?>" /></a>                    	
      </div>
      <?php } ?>
    </div> 
  </div>
