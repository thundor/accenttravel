...
$data['hotel_id'] = '';
$special_layout = $this->_controller=='Citybreaks';
...
<div class="tab-pane <?php echo $special_layout ? 'active' : ''; ?>" id="city-break" role="tabpanel">
  <form action="#" method="post" class="citybreak-search">
    ...
    <div class="row">
      ...
      <div class="form-group col-sm-12 col-md-6 col-lg-3">
        <input type="text" class="form-control form-control-lg" id="dateZborCB" placeholder="Selecteaza data" required autocomplete="off" />
      </div>                             
