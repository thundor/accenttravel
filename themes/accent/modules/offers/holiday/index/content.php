...
$offers_settings = $this->_ci->Options_model->get('offers_holiday_settings');
if(!$offers_settings){
...
<div class="container">
  <div class="tematice">
    <div class="row">
      ...
      <h1 class="col-sm-12 col-md-6 col-lg-4">Vacante tematice</h1>
      <div class=" col-sm-0 col-md-3 col-lg-4 borderTitle"></div>
      ...
      ?>
      <div class="col-6 col-sm-6 col-md-4 col-lg-3 oferta">
        <?php if($discount) { ?>
