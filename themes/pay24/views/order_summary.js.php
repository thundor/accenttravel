...
export default {
	components : {
		...
		'CustomOrderData' : order_data ? loadViewAsync('order_' + order_data.provider + '_' + order_data.type) : {
			template : `<h5>Nu s-au putut incarca informatiile comenzii</h5>`,
		},
		'GeneralOrderData' : order_data ? loadViewAsync('order_general') : {
			template : `<h5>Nu s-au putut incarca informatiile comenzii</h5>`,
		},
	},
	data: () => ({
