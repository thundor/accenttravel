...
<Modal v-model="dialog">
      ...
      <template v-slot:footer="{ props }">
        <v-btn class="text-none font-weight-normal cancel-button" size="x-large" color="secondary" rounded="theme" @click="dialog = false"><v-icon icon="mdi-arrow-left"></v-icon> Inapoi</v-btn>
